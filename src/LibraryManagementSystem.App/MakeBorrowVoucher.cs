...
using LibraryManagementSystem.App.Features.MakeBorrowVoucherFeature.Commands;
...
public partial class MakeBorrowVoucher : UserControl
{
    ...
    private async void btn_submit_Click(object sender, EventArgs e)
    {
        ...
        var readerId = cbb_Reader.SelectedValue.ToString();
        ...
        var bodyBorrowBook = new BorrowBookCommand()
        {
