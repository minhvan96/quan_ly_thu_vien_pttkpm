...
public class
    ListLibraryConfigurationsQueryHandler : IListQueryHandler<ListLibraryConfigurationsQuery, LibraryConfigurationDto>
{
    ...
    /// <inheritdoc />
    public async Task<IPagedList<LibraryConfigurationDto>> Handle(ListLibraryConfigurationsQuery request,
